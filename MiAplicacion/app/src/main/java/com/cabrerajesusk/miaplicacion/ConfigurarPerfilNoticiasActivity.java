...
public class ConfigurarPerfilNoticiasActivity extends AppCompatActivity {

    private TextView nombre;
    private ImageView fotoPerfil;
    private Button cambiarFoto,guardarConfiguracion;
    private EditText nroTelefono,rubro,barrio,calle,nroCasa;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_configurar_perfil_noticias);

        nombre = (TextView) findViewById(R.id.idNombreConfigurarPerfilNoticias);
        fotoPerfil = (ImageView) findViewById(R.id.idFotoConfigurarPerfilNoticias);
        cambiarFoto = (Button) findViewById(R.id.idCambiarFotoConfigurarPerfilNoticias);
        nroTelefono = (EditText) findViewById(R.id.idNroConfigurarPerfilNoticias);
        rubro = (EditText) findViewById(R.id.idRubroConfigurarPerfilNoticias);
        barrio = (EditText) findViewById(R.id.idBarrioConfigurarPerfilNoticias);
        calle = (EditText) findViewById(R.id.idCalleConfigurarPerfilNoticias);
        nroCasa = (EditText) findViewById(R.id.idNroCasaConfigurarPerfilNoticias);
        mostrar = (CheckBox) findViewById(R.id.idMostrarDireccionConfigurarPerfilNoticias);
        guardarConfiguracion = (Button) findViewById(R.id.idBotonGuardarConfigurarPerfilNoticias);
        verificar = (CheckBox) findViewById(R.id.idVerificarConfigurarPerfilNoticias);
        ...
        cambiarFoto.setOnClickListener(v -> {
            CropImage.startPickImageActivity(ConfigurarPerfilNoticiasActivity.this);
        });
    ...
    private void retunrLogin(){
        startActivity(new Intent(ConfigurarPerfilNoticiasActivity.this, LoginActivity.class));
        finish();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE && resultCode == Activity.RESULT_OK){
            ...
            CropImage.activity(imagenUri)
                    ...
                    .setAspectRatio(1,1).start(ConfigurarPerfilNoticiasActivity.this);
